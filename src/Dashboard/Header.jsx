            ...
            <div className="mx-auto w-full max-w-7xl">
                <nav className="navbar py-2">
                    <div className="navbar-start items-center gap-2">
                        <button type="button" className="btn btn-soft btn-square btn-sm lg:hidden">
                        ...
                        <div className="input no-focus border-0 px-0">
                            ...
                            <input type="search" className="grow placeholder:text-sm" placeholder="Type to Search..." />
                        </div>
                    </div>
                    <div className="navbar-end items-end gap-6">
                        <div className="max-md:hidden">
                            <a className="github-button" href="#">Welcome {user?.name}</a>
                        </div>
                    </div>
                </nav>
            </div>
